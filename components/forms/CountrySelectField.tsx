...
export const CountrySelectField = ({ name, control, label, error, required }: CountrySelectProps) => {
  return (
    <div className="space-y-2">
      ...
      <Controller
        ...
        render={({ field }) => {
          return <CountrySelect value={field.value} onChange={field.onChange} />;
        }}
      />
      ...
      <PopoverContent className="w-full p-0 bg-gray-800 border-gray-600" align="start">
        <Command className="bg-gray-800 border-gray-600">
          ...
          <CommandList className="max-h-60 bg-gray-800 scrollbar-hide-default">
            <CommandEmpty className="country-select-empty">No framework found.</CommandEmpty>
